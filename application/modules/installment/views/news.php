...
<div class="content-wrapper">
    <h3>Voucher Record<a href="<?php echo ADMIN_BASE_URL . 'installment'; ?>"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-chevron-left"></i>&nbsp;&nbsp;&nbsp;Back</button></a></h3>
