...
/////////////////////////Image Upload//////////////////////////////
    function upload_image($nId, $org_id) {
        ...
        if(isset($upload_image_file) && !empty($upload_image_file)){
            ...
            $file_name = 'gallery_' . $nId.'_'.$org_id . '_' . $upload_image_file;
        }
        else{
            $file_name ='';
        }
        $config['upload_path'] = './uploads/gallery/actual_images';
        ...
        $config['width'] = 500;
        $config['height'] = 400;
        $config['new_image'] = './uploads/gallery/large_images';
        ...
        $config['width'] = 300;
        $config['height'] = 200;
        $config['new_image'] = './uploads/gallery/medium_images';
        $this->image_lib->initialize($config);
        $this->image_lib->resize();
        $this->image_lib->clear();
        ...
        $config['width'] = 100;
        $config['height'] = 100;
        $config['new_image'] = './uploads/gallery/small_images';
        $this->image_lib->initialize($config);
        $this->image_lib->resize();
        $this->image_lib->clear();
